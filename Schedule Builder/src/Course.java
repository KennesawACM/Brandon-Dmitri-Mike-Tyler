 ...
 * Changes made by Brandon Bell 
 * About Changes: Changes were made to improve operating with builder class. Also implements the Comparable interface to allow for compareTo method. Method used for sorting classes in builder class.  
 */
